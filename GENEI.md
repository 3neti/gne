...
External document systems receive a versioned transfer contract, never GNE's repository machinery. The x-document adapter is an anti-corruption layer: GNE owns meaning and resolution; future x-document drivers own expression and output packaging. Contract evidence is descriptive provenance, not permission or instruction to read repository files.
