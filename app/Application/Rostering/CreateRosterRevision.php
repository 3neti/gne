...
final readonly class CreateRosterRevision
{
     ...
     */
    public function handle(?User $actor, RosterPeriod $period, string $reason, array $summary, RosterValidationResult $validation, array $changes, bool $recordAudit = true): RosterRevision
    {
