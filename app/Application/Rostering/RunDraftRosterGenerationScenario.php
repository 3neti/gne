...
final readonly class RunDraftRosterGenerationScenario
{
    ...
    public function handle(RosterLifecycleScenarioDefinition $scenario, bool $keepState = false): ManualRosterScenarioResult
    {
        ...
        try {
            ...
            $this->recordRequest->handle($actor, $doctors[0], $period, DoctorRequestType::Leave, ['2026-09-05']);
            $this->recordRequest->handle($actor, $doctors[1], $period, DoctorRequestType::Unavailable, ['2026-09-06']);
