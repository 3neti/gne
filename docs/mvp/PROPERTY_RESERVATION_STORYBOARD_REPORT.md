...
Generated output lives under `.gne/storyboards/property-reservation-mvp/`: manifest, 25 authenticated PNG captures, HTML, 26-page screenshot-bearing PDF, narration, movie manifest, and report. FFmpeg was unavailable in the reviewed environment, so MP4 is build-ready rather than generated.
