...
| Discovery/validation | Profiles, scenarios, artifacts, directories, duplicates | Unit/feature/scenario | Structural YAML/JSON checks; limited reference validation | Implemented | Add precise schema checks |
...
| Database projection | Idempotent full replacement and run ledger | Feature/scenario | Bootstrap tables; SQLite exercised | Implemented | Prove broader compatibility later |
